 ...
 * @author darwing
 */
public class PanelOcho extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PanelOcho
     */
    public PanelOcho() {
        initComponents();

        NumerosAleatorios numeroaleatorios = new NumerosAleatorios();
        mat = numeroaleatorios.matrizNumeros(4, 4, Pares.OCHO.getNumPar());
        this.matrizImages();
        lblhora.setText("Hora: " + datos.HORA);
        lblfecha.setText("Fecha: " + datos.fecha());
    ...
    private void initComponents() {
        ...
        panelOcho.setBackground(new java.awt.Color(255, 255, 255));
        panelOcho.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        add(panelOcho, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 240, 710, 600));
...
void matrizImages() {
        ...
        for (int i = 0; i < 4; i++)
        {
            for (int j = 0; j < 4; j++)
            {
                ...
                add(panelOcho, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130));
                //aqui se añaden junto con la 0

                panelOcho.add(matriz[i][j], new org.netbeans.lib.awtextra.AbsoluteConstraints((j * 130), (i * 156)));
                                    ...
                                    if (mat2[k][l] == 0 && contador != 2)
                                    {
                                        ...
                                        espera2 = new Timer(500, (ActionEvent e1) ->
                                        {
                                            if (contador == 2 && ban1 == 0)
                                            {
                                                ...
                                                ban1 = 1;
                                                turno++;
                                                lblturno.setText("Turno No: " + String.valueOf(turno));
                                            }
                                            if (contador == 2 && consegund == 2)
                                            {
                                                ...
                                                if (mat2[acposx][acposy] == mat2[anposx][anposy])
                                                {
                                                    ...
                                                    lblaciertos.setText("Aciertos: " + String.valueOf(aciertos));
