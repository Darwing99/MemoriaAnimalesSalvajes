...
public class PanelDoce extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PanelDoce
     */
    public PanelDoce() {
        initComponents();
        NumerosAleatorios numeroaleatorios = new NumerosAleatorios();
        mat = numeroaleatorios.matrizNumeros(4, 6, Pares.DOCE.getNumPar());
    ...
    private void initComponents() {
        ...
        panelDoce.setBackground(new java.awt.Color(255, 255, 255));
        panelDoce.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        add(panelDoce, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 240, 710, 600));
  ...
  void matrizImages() {
        ...
        for (int i = 0; i < 4; i++)
        {
            for (int j = 0; j < 6; j++)
            {
                ...
                add(panelDoce, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 130));
                //aqui se añaden junto con la 0

                panelDoce.add(matriz[i][j], new org.netbeans.lib.awtextra.AbsoluteConstraints((j * 130), (i * 156)));
                                        ...
                                        espera2 = new Timer(500, (ActionEvent e1) ->
                                        {
                                            ...
                                            if (contador == 2 && consegund == 2)
                                            {
                                                ...
                                                if (mat2[acposx][acposy] == mat2[anposx][anposy])
                                                {
                                                    ...
                                                    matriz[acposx][acposy].setIcon(new ImageIcon(DatosGenerales.URLGENERAL + mat2[acposx][acposy] + ".png"));
                                                    matriz[anposx][anposy].setIcon(new ImageIcon(DatosGenerales.URLGENERAL + mat2[anposx][anposy] + ".png"));
                                                    contador = 0;
